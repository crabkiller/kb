...
**A**:
Kubernetes（简称 K8s）是一个开源的**容器编排平台**，用于自动化部署、扩展和管理容器化应用程序。
...
**A**:
Kubernetes（K8s）的出现并不是为了制造复杂性，而是为了解决**在大规模生产环境中管理容器化应用**时遇到的各种棘手问题。
